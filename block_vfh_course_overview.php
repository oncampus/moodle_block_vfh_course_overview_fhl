...
require_once($CFG->dirroot.'/blocks/vfh_course_overview/lib.php');


class block_vfh_course_overview extends block_base {
    /**
     * block initializations
     */
    public function init() {
        $this->title   = get_string('pluginname', 'block_vfh_course_overview');
    }
    ...
    public function get_content() {
        ...
        if (empty($courses) && empty($remote_courses)) {
            ...
            printCoursesVFH($courses, $remote_courses);
